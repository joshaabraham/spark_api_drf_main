...
urlpatterns = [
    ...
    path('invitation/', InvitationListCreateView.as_view(), name='invitation-list-create'),
    path('invitation/<int:pk>/', InvitationDetailView.as_view(), name='invitation-detail'),
